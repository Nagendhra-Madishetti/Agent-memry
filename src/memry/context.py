...
Agent Memry as a standalone context engine: any model/agent asks for context "as of T" and
...
NON_SEMANTIC_RETRIEVAL_NOTE = (
    ...
    "[embeddings] extra) or 'bge-m3' (needs MEMRY_EMBEDDER_API_KEY). See the Quickstart."
)
OVERFETCH_SATURATED_NOTE = (
    "The retrieval over-fetch window was saturated: a valid fact ranked below it may have been "
    "missed. Raise MEMRY_OVERFETCH_FACTOR / MEMRY_MIN_OVERFETCH, or narrow the query."
)
