    ...
    <>
          ...
          <Reveal delay={0.2}>
            <div className="ring-glow mesh-panel mt-14 max-w-3xl rounded-xl p-6">
              ...
              <dl className="space-y-3 text-[15px]">
                <Row k="Agent Memry · as of 2015" v={clean(H.past_2015.answer)} good />
                <Row k="Agent Memry · now" v={clean(H.now.answer)} good />
      ...
      <Section eyebrow="What sets it apart" title="Plain RAG. Temporal RAG. Bitemporal RAG.">
        <p className="text-subhead max-w-[64ch]">
          ...
          replay a belief that was corrected later. That last class is Agent Memry.
        </p>
        <div className="mt-8">
          <CapabilityClasses />
        </div>
      ...
      <Section eyebrow="Real benchmark - every number from a live run" title="Where it isn't close">
        <p className="text-subhead max-w-[64ch]">
          ...
          past date), only Agent Memry answers correctly.
        </p>
          ...
          <div className="flex flex-col justify-center gap-3">
            ...
            <div className="ring-glow rounded-lg border border-brand/30 bg-brand/[0.05] p-4">
              ...
              <div className="mt-1 text-sm">
                <span className="font-semibold text-brand">Agent Memry {systems.find((s) => s.name.startsWith("Agent Memry"))?.as_of.score}/{bn}</span>
            ...
            <Reveal>
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                <LinkButton href="/docs" size="lg" className="h-12 px-6 font-semibold">
                  Deploy Agent Memry <ArrowRight className="size-4" />
                </LinkButton>
