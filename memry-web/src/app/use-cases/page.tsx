...
const CASES = [
  ...
  },
  {
    ...
    body: "Decisions must cite the fact that was valid at decision time, not today's. Agent Memry serves the as-of truth and the provenance behind it, so every answer is defensible after the fact.",
  },
  {
    icon: LifeBuoy,
  ...
  },
  {
    ...
    body: "When a fact changes, most memory silently overwrites the past. Agent Memry supersedes with both timestamps, so an agent can still reason about what it believed before.",
  },
  {
    icon: Lock,
  ...
  },
  {
    ...
    body: "Any answer that could be contested needs provenance and a timeline. Agent Memry makes 'is it still true, and how sure are we' answerable for every fact it serves.",
  },
];
    ...
    <div className="mx-auto max-w-6xl px-5 py-12">
      <Reveal>
        ...
        <p className="text-subhead mb-10 max-w-[64ch]">
          Agent Memry earns its place wherever an answer must be defensible after the fact - 
