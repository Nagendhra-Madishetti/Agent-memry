        ...
        <div className="mb-8 flex items-start gap-3 rounded-xl border border-warn/40 bg-warn/10 p-4 text-sm">
          ...
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Start it to configure plugins live: <code className="rounded bg-secondary px-1.5 py-0.5">python memry-api/main.py</code>
            </p>
          </div>
        </div>
      )}
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Reveal delay={0.15}>
          <Layer icon={<Database className="size-4" />} title="Graph backend" desc="The bi-temporal store.">
            ...
            <p className="mt-3 text-xs text-muted-foreground">Same driver abstraction; set via <code className="rounded bg-secondary px-1 py-0.5">MEMRY_BACKEND_DRIVER</code>.</p>
          </Layer>
        </Reveal>
      </div>
