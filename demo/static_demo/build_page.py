...
<title>Agent Memry - the RAG that knows *when*</title>
<style>
...
<body><div class="wrap">
<h1>Agent Memry - the RAG that knows <em>when</em></h1>
...
<div class="card lead">
 ...
 <div class="row"><div class="k">Agent Memry - now</div><div class="a" id="now"></div></div>
 <div class="row"><div class="k">Agent Memry - as of 2015</div><div class="a" id="past"></div></div>
...
document.getElementById("foot").innerHTML =
  ...
  `<code>memry.serving.audit.run(backend)</code> (the live replay dashboard).`;
</script>
</body></html>"""
